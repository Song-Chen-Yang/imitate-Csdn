...
.user_info .user_info_bio p {
  margin: 0;
  font-size: .7rem;
}
.user_info .user_info_bio p span {
  margin: 0 5px;
}
.user_info .user_info_bio p span img {
  width: 15px;
  margin-right: 5px;
}
.user_info .user_info_bio p:first-child {
  font-size: .9rem;
  font-weight: bold;
  text-indent: 4px;
}
